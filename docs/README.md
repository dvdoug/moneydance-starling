...
| File | Purpose |
| --- | --- |
| [product.md](product.md) | Why this exists and what v1 does |
| [architecture.md](architecture.md) | How the extension is put together |
| [starling-api.md](starling-api.md) | Personal API contract |
| [marketplace.md](marketplace.md) | Infinite Kind listing |
