...
Pending card holds and upcoming Direct Debits show `[PENDING]` until they settle. The Starling app often keeps the tap time; Moneydance uses the UK **settlement** date so it lines up with a statement.
